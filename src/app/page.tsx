...
export default function HomePage() {
  ...
  const quickStats = [
    { label: "设备总数", icon: <DevicesIcon />, value: isLoading ? "..." : deviceTotal, color: "primary" },
    { label: "库存总量", icon: <InventoryIcon />, value: isLoading ? "..." : inventoryTotal, color: "info" },
    { label: "进行中订单", icon: <OrderIcon />, value: isLoading ? "..." : activeOrders, color: "warning" },
    { label: "维修中设备", icon: <RepairIcon />, value: isLoading ? "..." : repairTotal, color: "error" },
  ];
